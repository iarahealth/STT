...
from iarahealth_stt_training.util.config import initialize_globals_from_args
from iarahealth_stt_training.train import train
from iarahealth_stt_training.evaluate import test
